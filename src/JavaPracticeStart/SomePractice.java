...
//        double a = scanner.nextDouble();                                //nextLine/nextInt/nextDouble - считывает и возвращает данные
...
//        }                                                           //return - одновременно возвращает значение и завершает работу метода
...
//        }
        ...
        super() - это ключевое слово в Java, которое используется в дочерних классах для вызова конструктора родительского класса.
        Также оно позволяет обращаться к методам родительского класса в дочернем классе (когда необходимо вызвать оригинальную логику).
